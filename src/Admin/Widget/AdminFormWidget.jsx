      ...
      switch (name) {
        ...
        case "ic":
          ...
          if (!icPattern.test(value)) {
            error = 'Sila masukkan IC dengan format "123456-12-1234"';
          }
          break;
        case "phoneNumber":
          const phonePattern = /^\d{10,11}$/;
          if (!phonePattern.test(value)) {
            error = "Nombor telefon mestilah 10 atau 11 digit";
          }
          break;
        case "password":
  ...
  const handleFormSubmit = async () => {
    ...
    if (allValid) {
      ...
      if (isUnique) {
        ...
        isEditMode
          ? toast(<CustomToast message="Maklumat berjaya dikemaskini." />)
          : toast(<CustomToast message="Pendaftaran admin berjaya." />) 
        handleClose();
      } else {
        setErrors((prevErrors) => ({
          ...prevErrors,
  ...
  return (
    ...
    >
      <Typography variant="h6">
        {isEditMode ? "Kemaskini Admin" : "Daftar Admin"}
      </Typography>
...
export default AdminFormWidget;
